...
void display_menu(std::string* a) {
    std::cout << Bold(Blue(" 1")) << Orange(" - Display the list") << std::endl
              ...
              << Bold(Blue(" 4")) << Orange(" - Add node at the ") + Bold(Orange("n")) + Orange(" position")
              << std::endl
              << Bold(Blue(" 5")) << Orange(" - Delete node from the end") << std::endl
              << Bold(Blue(" 6")) << Orange(" - Delete node from the start") << std::endl
              << Bold(Blue(" 7")) << Orange(" - Delete node from the ") + Bold(Orange("n")) + Orange(" position")
              << std::endl
              << Bold(Blue(" 8")) << Orange(" - Change data from the ") + Bold(Orange("n")) + Orange(" position")
              << std::endl
