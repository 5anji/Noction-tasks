...
void Menu::run(Linked_List& list) {
    ...
    do {
        ...
        case str::option_1: list.Print_List(); break;
        case str::option_2: {
            std::string temp;
            std::cout << "Input data: ";
            std::cin >> temp;
        ...
        case str::option_5: list.Del_Node_End(); break;
        case str::option_6: list.Del_Node_Start(); break;
        case str::option_7: {
            int position;
        ...
        //   break;
        // }
        case str::option_d: list.Del_List(); break;
        case str::option_c: system("clear"); break;
        case str::option_q: std::cout << "Exited." << std::endl; break;
        default: std::cout << Bold(Red("\vERROR (no such str::option). Input again.\v")) << std::endl; break;
        }
    } while (checker != "q");
}
